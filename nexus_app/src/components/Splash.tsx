...
const Splash: React.FC = () => {
  ...
  const scanPosition = Math.max(progress - 10, 0);
    ...
    <div className="fixed inset-0 bg-[#0a0a0c] flex flex-col items-center justify-center z-50">
      ...
      <div className="relative w-64 h-64 mb-12 flex items-center justify-center">
        ...
        <div className="text-center z-10 flex flex-col items-center">
          <svg
            ...
            height="40"
            viewBox="0 0 100 100"
            className="text-blue-500 mb-4 drop-shadow-[0_0_10px_rgba(59,130,246,0.5)]"
          >
            <path
          ...
          <div className="text-white font-black tracking-[0.6em] text-2xl uppercase ml-[0.6em] animate-pulse">
            NEXUS
          </div>
          <div className="text-[8px] text-blue-400 font-bold mt-2 mono tracking-[0.4em] uppercase opacity-60">
            System Initializing
          </div>
        </div>
      </div>
      ...
      <div className="w-72 space-y-4">
        <div className="flex justify-between items-end mb-1">
          <span className="text-white/20 text-[9px] uppercase tracking-[0.3em] mono font-bold">
            Establishing Secure Link...
          </span>
          <span className="text-blue-500 text-xs mono font-black">
            {progress}%
          </span>
        </div>
        ...
        <div className="w-full h-[1px] bg-white/5 overflow-hidden rounded-full relative">
          ...
          />
          <div
            className="absolute top-0 bottom-0 w-8 bg-gradient-to-r from-transparent via-white/20 to-transparent animate-[scan-horizontal_2s_infinite]"
